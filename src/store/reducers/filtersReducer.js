...
export const filtersReducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case 'APP_INCREASE_CAT_NAME_INDEX':
			...
			return {
				...state,
				app : { ...state.app, currentCatNameIndex: state.app.currentCatNameIndex + 1, currentCatItemIndex: 0 }
			};
		...
		case 'APP_INCREASE_CAT_ITEM_INDEX':
			...
			return {
				...state,
				app : { ...state.app, currentCatItemIndex: state.app.currentCatItemIndex + 1 }
			};
